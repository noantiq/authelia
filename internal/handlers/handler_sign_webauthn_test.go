...
func TestWebAuthnAssertionPOST(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			func(t *testing.T, mock *mocks.MockAutheliaCtx) {
				AssertLogEntryMessageAndError(t, mock.Hook.LastEntry(), "Error occurred validating a WebAuthn authentication challenge for user 'john': error parsing the request body", "Parse error for Assertion (invalid_request): Error reading '{\"id\":true,\"rawId\":\"rwOwV8WCh1hrE0M6mvaoRGpGHidqK6IlhkDJ2xERhPU\",\"response\":{\"authenticatorData\":\"DGygg5w6VoNVeDP2GKJVZmXfKgiJZHh9U4ULStTTvtwFAAAAAw\",\"clientDataJSON\":\"\",\"signature\":\"MEQCIBlJ2Fxf6ZwLNTCQglz0AW0pD4HlU8W5Yk696jjfxVxhAiAhAMkLh8iKyhW6zSmzwfQDjMF2nKjVHzEs7jLHRPDZ2A\"},\"type\":\"public-key\",\"clientExtensionResults\":{},\"authenticatorAttachment\":\"cross-platform\"}': json: cannot unmarshal bool into Go struct field CredentialAssertionResponse.id of type string")
			},
		},
		{
			"ShouldFailBadJSON",
