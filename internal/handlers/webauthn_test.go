	...
	testCases := []struct {
	...
	}{
		{
			...
			func(t *testing.T, mock *mocks.MockAutheliaCtx, user *model.WebAuthnUser) {
				...
				assert.Equal(t, []byte{0x61, 0x6d, 0x39, 0x6f, 0x62, 0x6a, 0x45, 0x79, 0x4d, 0x77}, user.WebAuthnID())
		...
		},
		{
			...
			func(t *testing.T, mock *mocks.MockAutheliaCtx, user *model.WebAuthnUser) {
				...
				assert.Equal(t, []byte{0x50, 0x57, 0x4e, 0x72, 0x51, 0x6c, 0x4a, 0x6c, 0x4c, 0x69, 0x56, 0x6d, 0x63, 0x48, 0x74, 0x33, 0x49, 0x30, 0x74, 0x62, 0x63, 0x58, 0x63, 0x30, 0x4b, 0x55, 0x46, 0x58, 0x54, 0x56, 0x70, 0x79, 0x51, 0x56, 0x41, 0x70, 0x4b, 0x48, 0x6f, 0x7a, 0x54, 0x6c, 0x56, 0x30, 0x4e, 0x57, 0x34, 0x7a, 0x5a, 0x7a, 0x38, 0x37, 0x50, 0x69, 0x64, 0x65, 0x55, 0x6e, 0x41, 0x2d, 0x4b, 0x32, 0x56, 0x46, 0x4e, 0x48, 0x6f, 0x2d, 0x57, 0x31, 0x34, 0x75, 0x50, 0x44, 0x4d, 0x5f, 0x4a, 0x6d, 0x34, 0x37, 0x54, 0x45, 0x30, 0x6a, 0x64, 0x77}, user.WebAuthnID())
				assert.Equal(t, testUsername, user.WebAuthnName())
				assert.Equal(t, testUsername, user.Username)
